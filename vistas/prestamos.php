        ...
        <div class="col-lg-12">
            <div class="main-box clearfix">
                <header class="main-box-header clearfix">
                     <h1 class="box-title">Prestamos<br><br> <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button></h1>
                </header>
                    ...
                    <form name="formulario" id="formulario" method="POST">
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                           ...
                           <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="prorroga" id="prorroga" required >
